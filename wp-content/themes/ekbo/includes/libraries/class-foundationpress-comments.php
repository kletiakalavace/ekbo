...
class Foundationpress_Comments extends Walker_Comment {
	...
	function __construct() { ?>
		...
		<h3><?php comments_number( __( 'No Responses to', 'dhwpfstart' ), __( 'One Response to', 'dhwpfstart' ), __( '% Responses to', 'dhwpfstart' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
	...
	function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
		...
		<header class="comment-author">
			...
			<?php
				...
				printf( __(
					'<cite class="fn">%s</cite>', 'dhwpfstart' ),
